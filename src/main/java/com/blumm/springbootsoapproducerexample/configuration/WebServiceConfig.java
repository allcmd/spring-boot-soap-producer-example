package com.blumm.springbootsoapproducerexample.configuration;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11DefinitionCountries(XsdSchema countriesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://blumm.com/producing-ws");
        wsdl11Definition.setSchema(countriesSchema);
        return wsdl11Definition;
    }

    @Bean(name = "employees")
    public DefaultWsdl11Definition defaultWsdl11DefinitionEmployees(XsdSchema employeesSchema) {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
